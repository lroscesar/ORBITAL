...
import { Plus, X, GitBranch, Download, ChevronRight, UserCircle } from "lucide-react"
      ...
      <div className="h-14 shrink-0 flex items-center px-4 gap-3 border-b border-border" style={{ background: "#071428" }}>
        <div className="flex items-center gap-2.5 mr-2">
          ...
          <div>
            ...
            <div style={{ fontFamily: mono, fontSize: 9, color: "#5a7ab0", letterSpacing: "0.1em" }}>TAR · TEORIA DA PROMESSA</div>
          </div>
        </div>
